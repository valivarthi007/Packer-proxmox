...
source "proxmox" "ubuntu-server-focal" {
    ...
    boot_command = [
        ...
        "<f6><wait><esc><wait>",
        "<bs><bs><bs><bs><bs>",
        "autoinstall ds=nocloud-net url=http://{{ .HTTPIP }}:{{ .HTTPPort }}/ ",
        "<enter>",
    ]
    ...
    http_directory = "E:\\Proxmox_labs\\http" 
    # (Optional) Bind IP Address and Port
    http_bind_address = "Address of files machine"
    http_port_min = 8802
    http_port_max = 8802

    ssh_username = "diwakar"

    # (Option 1) Add your Password here
    # ssh_password = "your-password"
    # - or -
    # (Option 2) Add your Private SSH KEY file here
    ssh_private_key_file = "E:\\Proxmox_labs\\packer"
